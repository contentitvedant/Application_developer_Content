...
const AddTask = () => {
    ...
    return (
        <div className="page-background default-font">
            <form className="form-container">
                <div className="form-segment">
                    <h1 className="light-text">Add Task</h1>
                </div>
                ...
                <button type="submit" className="button-element button-red" onClick={handleSubmit}><ion-icon name="add-outline"></ion-icon></button>
